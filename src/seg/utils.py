...
def bkg_transforms(img, bkg, sigma):
    ...
    curr_scaled = ndi.gaussian_filter(curr_scaled, sigma = 1.0, mode = 'constant', cval = 0, truncate = 2)
    return curr_scaled

def astro_preprocess(img, estimator, box = (50, 50), filt = (3, 3), sigma = 3, sig_clip = 3, pad = 0, smooth = True):
